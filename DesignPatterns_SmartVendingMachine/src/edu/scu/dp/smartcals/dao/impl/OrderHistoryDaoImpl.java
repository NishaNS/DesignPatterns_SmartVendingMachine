...
public class OrderHistoryDaoImpl implements OrderHistoryDao {
	...
	@Override
	public List<ProductModel> getBestSellingProduct(long vmId)
			throws SQLException {
		...
		try {
			statement = connection
					.prepareStatement("select count(*) product_count,o.ProductId from orderdetails o,product p where  o.ProductId = p.ProductID group by o.ProductId,o.VendingMachineId having VendingMachineId=? order by product_count desc limit 3");
	...
	public void updateOrderTable(InventoryModel invProd, String PaymentType,
			long SmartCalCardNo) throws SQLException {
		PreparedStatement statement = null;
		String query;
		Connection connection = databaseFactory.getConnection();
		try {
